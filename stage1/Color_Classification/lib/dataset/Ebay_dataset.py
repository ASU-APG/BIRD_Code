...
class EbayColor(Dataset):
    ...
    def __init__(self, root_dir, feat_size, transform=None):
        ...
        # self.col_code = labels_col 
        # self.images_arr = images_arr # train_list 
    ...
    def __getitem__(self, index):
        ...
        # # !!!!!! FROM MBD !!!!!!!
        # image_arr = self.images_arr[index]
        # arrangement = self.arr_code[index] 
        # color = self.col_code[index]
        # # print(color.shape)
        # sample = {'image_arr': image_arr, 'arrangement': arrangement, 'color': color}
