...
#SBATCH --gres=gpu:4               # Request x GPUs (max 4)
#SBATCH -t 3-12:00                  # wall time (D-HH:MM)

#SBATCH -o slurm.%j.mse.0.001.64.out              # STDOUT (%j = JobId)
#SBATCH -e slurm.%j.mse.0.001.64.err	           # STDERR (%j = JobId)

module load tensorflow/1.8-agave-gpu
source ~/work/code/pytorch1_0/bin/activate
# pip3 install pandas
# pip3 install h5py 
cd /home/tgokhale/work/code/e2e_pspnet
# python3 csv_h5py_dataloader.py
python3 test.py --loss_type mse --learning_rate 0.001 --batch_size 64 --val_batch_size 64  --num_val_samples 200000
