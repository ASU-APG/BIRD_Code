...
class RandomDataset(Dataset):
    ...
    def __init__(self, size, length):
        self.len = length
        self.data = torch.randn(length, size, 256, 256)
...
rand_loader = DataLoader(dataset=RandomDataset(inplanes, 20),
...
class Model(nn.Module):
    ...
    def __init__(self, input_size, output_size, inplanes, planes):
...
model = Model(input_size, output_size, inplanes, 16)
